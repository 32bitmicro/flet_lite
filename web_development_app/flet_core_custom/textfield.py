...
class TextField(FormFieldControl):
    ...
    def __init__(
        ...
        # to make 'flet_lite' get textfield updates on real-time
        self.on_change = self.on_typing
    

    def on_typing (self, e):
        print("On type!")
        if self.page != None:
            update_value(control_number=self.flet_lite_number, new_value=self.value)
